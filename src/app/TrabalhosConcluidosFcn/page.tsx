...
export function TrabalhosConcluidosFcn() {
...
const loadWithDelay = async () => {
  ...
  return TrabalhosConcluidosFcn;
};

const trabalhosConcluidosFcn = dynamic(() => loadWithDelay(), {
  ssr: false,
  loading: () => (
...
export default trabalhosConcluidosFcn