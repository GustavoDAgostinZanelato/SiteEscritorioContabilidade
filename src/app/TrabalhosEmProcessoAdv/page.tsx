...
export function TrabalhosEmProcessoAdv() {
...
const loadWithDelay = async () => {
  ...
  return TrabalhosEmProcessoAdv;
};

const trabalhosEmProcessoAdv = dynamic(() => loadWithDelay(), {
  ssr: false,
  loading: () => (
...
export default trabalhosEmProcessoAdv
