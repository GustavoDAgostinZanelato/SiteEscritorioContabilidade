...
export function TrabalhosEmProcessoAdm() {
...
const loadWithDelay = async () => {
  ...
  return TrabalhosEmProcessoAdm;
};

const trabalhosEmProcessoAdm = dynamic(() => loadWithDelay(), {
  ssr: false,
  loading: () => (
...
export default trabalhosEmProcessoAdm;